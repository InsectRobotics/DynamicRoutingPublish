...
if __name__ == "__main__":
    ...
    #             task_path=path_dict['task_path'], random_start=False)
    if goal_provided:
        env = gym.make(environment, multi_route_prob=0.1, plot_path=path_dict['plot_path'],
    ...
    ForceRendering = True
    dt = 0.02
    high_potential_update_period = 10000  # steps
    ...
    DRN.init_second_order_synapse(number_of_action_neurons=number_of_action_neurons, weight=0.01,
    ...
    for i_episode in range(max_number_of_episodes):  # run 20 episodes
        ...
        while True:  # run until episode is done
            ...
            DRN.reinfrocement_learning(reward=adapted_reward, done=done, if_target_state=reward >= 10,
